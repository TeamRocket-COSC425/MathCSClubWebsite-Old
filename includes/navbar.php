      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="mentor.php">Mentor Program</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
				...
				<li><a href="mathCode.php">Math Code</a></li> 
				
                <li><a href="skills.php">Skill Enhancer </a></li> 
				
                <li><a href="https://www.salisbury.edu/mathcosc/docs/Tutors/TutoringScheduleFall2015.pdf">Tutor Schedule</a></li>
              </ul>
            </li>
