 <?php
    ...
    <div class="container">
    	...
    	<div class="row">
          ...
          <p>
               If you are interested in becoming a member and have not yet been contacted, e-mail <a href="mailto:mjbardzell@salisbury.edu">Dr. Mike Bardzell</a>.
          </p>
          <p>For more information, visit <a href="www.pme-math.org">pme-math.org</a></p>
    		</div>
    		<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2"></div>
      ...
      <div class="row">
        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2"></div>
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
          <img src="images/phimu2008.jpg" style="padding-bottom:1%;"/>
