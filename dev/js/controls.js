...
function controls(){	
	...
	this.modalControl= function(){
		...
		$("#apply2BMentorBtn").live("click", function(){
		...
		$("#cancelAppBtn").live('click', function(){
			$("#modal").fadeOut();
		});

		$(".mentorItem").live("click", function(){
		...
		$("#mentor_app_img_file").live("change", function(){
		...
		$("#selectMentor").live("click", function(){
		...
		$("#assignMentor").live("click", function(){
				var msg = $("#msg").val();
		...
		//Close the modal
		$("#modalBackBtn").live('click', function(){
			$("#modal").fadeOut();
		});
	}	
	...
	this.frameMentorsMaint = function(){
		...
		//Shows image preview when user selects a file in the "Apply to be Mentor" Modal
		$("#mentor_img_file").live("change", function(){
			console.log("Image changed");
			var url = this.value;
    		var ext = url.substring(url.lastIndexOf('.') + 1).toLowerCase();
    		if (this.files && this.files[0]&& (ext == "gif" || ext == "png" || ext == "jpeg" || ext == "jpg")) {
	...
	this.frameAdmin = function(){
		...
		$("#changePhotoAdmin").live("click", function(){
