...
?>
    ...
    <div>
      <img src="images/gullcode_sp2014_Carousel.png" alt ="400"  width="1000"/>
    </div>
    <p align="center" class="credit">  Image from "Gull Code -Spring 2014" </p>

    <p><b>Date:</b> March 28, 2015</p>
    <p><b>Time:</b> 10am - 3am</p>
    <p><b>Location:</b> Salisbury University, Henson Science building</p>
    <p><b>Details:</b></p>
    <p>Teams will be given a set of problems to be solved using either JAVA or C++ which will require a logical or mathematical algorithm to solve.<br><br>
    ...
    <p>Registration deadline: March 26th, 2015</p>
    <p><b>Prizes:<br> 
    ...
    <p><b>All team members will be given a T-shirt for participating and we will have multiple door prizes and food!</b></p>
        ...
        <div align="center" class="register" style="background-color: rgba(230,229,227,0.9);">
          ...
          <table>
                ...
                if(!isset($_SESSION['loggedin'])) { ?>
                    <tr><td colspan="2" align="center"><input type="submit" value="Login" id="gullCodeLogin"/></td></tr> 
                <?php 
                }else{ ?>
        ...
        <p style="font-size: 1.5em; font-weight:bold text-align:center;" align="center"> Please email any questions to: sumathcsclub@gmail.com</p>       

    </div>
    <div><p class="sponsor" style="font-size: 3em; text-align: center;"> Thank you to all of our Sponsors!</p>
      <p>
